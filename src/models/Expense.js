...
const Expense = sequelize.define('Expense', {
    ...
    entry_type: { type: DataTypes.ENUM('INWARD', 'OUTWARD'), defaultValue: 'OUTWARD' },
    category: { type: DataTypes.STRING(100) }, // FOOD, TRAVEL, OFFICE, INTERNET, REPLENISHMENT, etc.
    ...
    payment_url: { type: DataTypes.STRING(255) },
